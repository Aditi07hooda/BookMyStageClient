...
const RepairForm: React.FC = () => {
  ...
  const onSubmit: SubmitHandler<FormData> = (data) => {
    ...
    formData.append('to', 'anirudhrai503@gmail.com');
    ...
    axios
      .post(`${process.env.BASE_URL}email/send-repair-request`, formData, {
  ...
  return (
    <div className="bd-repair__area pt-115 pb-130">
      <div className="container small-container">
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <h2 className="bd-section__title text-center mb-55">Repair Form</h2>
                  ...
                  <div className="row">
                    ...
                    <div className="col-xxl-12 mb-6">
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Attach Images (optional)(limit upto 5 format jpeg|jpg|png|gif)
                      </label>
